...
# Allowed URL schemes and blocked private networks for SSRF protection
...
def _validate_url(url: str) -> None:
    ...
    try:
        ...
        pass  # DNS resolution failure will be caught by the actual request


def _validate_host(host: str) -> None:
    """Validate host to prevent SSRF/port-scanning attacks."""
    try:
...
class HealthChecker:
    ...
    def check_port(self, host: str, port: int, timeout: int = 5) -> Dict[str, Any]:
        ...
        # Validate host to prevent port-scanning attacks
        _validate_host(host)
