...
class EntityConsolidationAnalyzer:
    ...
    def calculate_backbone_entity_mapping(self) -> Dict:
        ...
        backbone_components = {
            "multi_org_system": {
                ...
                "shared_entities": ["Organization", "Role", "Permission"],
        ...
        schema_patterns = [
            {
                ...
                "platforms": 15,
                "consolidation_approach": "Shared Auth (Clerk) + org-scoped users",
            ...
            },
            {
                ...
                "platforms": 12,
                "consolidation_approach": "Backbone org isolation + RLS policies",
                "estimated_reduction": "80% consolidation via shared org model",
            },
            {
                "pattern": "Notifications",
                "tables": ["notifications", "email_queue", "sms_queue"],
                "platforms": 15,
                "consolidation_approach": "Shared notification service (multi-org)",
            ...
            },
            {
                ...
                "platforms": 8,
                "consolidation_approach": "Shared Stripe integration + org isolation",
    ...
    def calculate_data_migration_complexity(self) -> Dict:
        ...
        return {
            ...
            "total_entities_to_migrate": sum(
                p["total_entities"] for p in self.platform_entities.values()
            ),
            "average_migration_weeks": round(
                sum(c["estimated_migration_weeks"] for c in complexity_breakdown)
                / len(complexity_breakdown),
                1,
            ),
        }

    def _estimate_migration_weeks(
        self, total_entities: int, entity_type_count: int
    ) -> int:
