...
Understanding-oriented documentation discussing concepts and design decisions.

## Architecture Decisions

- [Why Evidence-First](evidence-first.md) — Hash-chained audit trails as a core invariant
- [Org Isolation Model](org-isolation.md) — Multi-tenant data isolation strategy
...
- [AI Risk Management](ai-risk-management.md) — NIST AI RMF alignment philosophy
