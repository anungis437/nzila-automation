...
function parseArgs(): MigrationConfig {
  ...
  if (!sourceConnectionString) {
    console.error('❌ LEGACY_PONDU_DATABASE_URL is required')
    process.exit(1)
  }
...
async function main() {
  ...
  console.log('═══════════════════════════════════════════════════════════')
  console.log('  Pondu Ops → NzilaOS Agri: Core Data Migration')
