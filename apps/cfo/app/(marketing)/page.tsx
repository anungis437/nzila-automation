...
const stats = [
  { value: "5,000+", label: "Clients Managed" },
  { value: "99.5%", label: "Reconciliation Accuracy" },
  { value: "40+", label: "Tax Jurisdictions" },
  { value: "<4h", label: "Avg Report Time" },
];
...
const features = [
  {
    ...
    description:
      "Unified view of all client financials with health scores, cash flow forecasts, and real-time alerts across your portfolio.",
    icon: "📊",
  },
  {
    title: "General Ledger",
    description:
      "Multi-entity journal management with CSV import, automated reconciliation, and audit-ready trail for every transaction.",
    icon: "📒",
  },
  {
    title: "Advisory Reports",
    description:
      "AI-generated financial reports with configurable templates, trend analysis, and board-ready presentation formatting.",
    icon: "📋",
  },
  {
    title: "Compliance Engine",
    description:
      "Automated tax filing status, regulatory deadline tracking, and multi-jurisdictional compliance monitoring.",
    icon: "🔒",
  },
  {
    title: "Workflow Automation",
    description:
      "Drag-and-drop workflow builder for recurring engagements, onboarding sequences, and approval chains.",
    icon: "⚡",
  },
  {
    title: "Team Collaboration",
    description:
      "Role-based access, dual-control workflows, secure document sharing, and client portal with self-service capabilities.",
    icon: "👥",
  },
];
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-32">
          ...
          <ScrollReveal delay={0.2}>
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-300 md:text-xl">
              Empower your firm with AI-driven financial analysis, automated
              compliance reports, and real-time client insights across every
              engagement.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="text-center">
              <h2 className="font-poppins text-3xl font-bold text-navy md:text-4xl">
                Enterprise CFO Intelligence
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">
                Everything your advisory firm needs to scale
              </p>
            </div>
          </ScrollReveal>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <ScrollReveal direction="left">
              <div>
                <h2 className="font-poppins text-3xl font-bold text-navy md:text-4xl">
                  Scaling Advisory with Intelligence
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-slate-600">
                  LedgerIQ empowers accounting firms to manage 10x more clients
                  without adding headcount. AI-driven insights surface critical
                  issues before they become problems, while automation handles
                  the repetitive work.
                </p>
                <p className="mt-4 font-poppins font-semibold text-electric">
                  Built in Canada for the world&apos;s most demanding advisory
                  practices.
                </p>
              </div>
            </ScrollReveal>
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          <ScrollReveal>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-300">
              Join hundreds of firms using LedgerIQ to deliver better client
              outcomes, faster.
            </p>
            <div className="mt-10">
              <Link
