...
export const metadata: Metadata = {
  title: 'Sign In | NACP Exams',
  description: 'Sign in to your NACP Exams account — secure national examination management with full audit trail.',
};
...
export default function SignInPage() {
  return (
    <AuthPageLayout
      ...
      heroAlt="Students taking a national examination — representing the integrity NACP Exams protects"
      trustBadges={[
