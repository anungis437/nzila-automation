/**
 * AI client — NACP Exams app.
 *
 * Provides a singleton AI client for exam intelligence features:
 * plagiarism detection, question generation, and marking assistance.
 *
