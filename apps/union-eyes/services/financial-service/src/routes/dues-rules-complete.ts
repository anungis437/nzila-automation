...
const createDuesRuleSchema = z.object({
  ...
  copePercentage: z.coerce.number().default(0),
  pacAmount: z.coerce.number().default(0),
  strikeFundPercentage: z.coerce.number().default(0),
  
  // Late fees
  gracePeriodDays: z.coerce.number().int().default(7),
