/**
 * GET POST /api/analytics/cross-tenant
 ...
 * SECURITY: cross-tenant routes require platform_lead or above (not org-level admin)
 */
...
export const GET = withApi(
  {
    ...
    openapi: {
      ...
      summary: 'Cross-tenant analytics metrics (GET)',
...
export const POST = withApi(
  {
    ...
    openapi: {
      tags: ['Analytics', 'Django Proxy'],
      summary: 'Cross-tenant analytics metrics (POST)',
      description: 'Proxied to Django: /api/analytics/analytics-metrics/ — platform-only',
    },
  },
  async ({ request }) => {
