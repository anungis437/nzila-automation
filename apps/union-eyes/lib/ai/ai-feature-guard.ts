 ...
 * AI Feature Guard
 *
 * Wraps every AI endpoint with:
 * 1. Feature flag check  → 403 if disabled
 * 2. Audit event         → logs AI invocations
...
const AI_DISCLAIMER =
  'This output was generated by AI. It is advisory only and does not constitute a binding decision. ' +
