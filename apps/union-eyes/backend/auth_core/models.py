...
class OrganizationUsers(BaseModel):
    ...
    organization = models.ForeignKey('Organizations', on_delete=models.CASCADE, related_name='organization_users_organization_set')
...
class OrganizationMembers(BaseModel):
    ...
    user_id = models.TextField()
    organization = models.ForeignKey('Organizations', on_delete=models.CASCADE, related_name='organization_members_organization_set')
...
class SsoProviders(BaseModel):
    ...
    organization = models.ForeignKey('Organizations', on_delete=models.CASCADE, related_name='sso_providers_organization_set')
...
class ScimConfigurations(BaseModel):
    """Migrated from drizzle: sso-scim-schema.ts"""
    organization = models.ForeignKey('Organizations', on_delete=models.CASCADE, related_name='scim_configurations_organization_set')
...
class SsoSessions(BaseModel):
    """Migrated from drizzle: sso-scim-schema.ts"""
    provider = models.ForeignKey('SsoProviders', on_delete=models.CASCADE, related_name='sso_sessions_provider_set')
...
class ScimEventsLog(BaseModel):
    """Migrated from drizzle: sso-scim-schema.ts"""
    config = models.ForeignKey('ScimConfigurations', on_delete=models.CASCADE, related_name='scim_events_log_config_set')
...
class MfaConfigurations(BaseModel):
    """Migrated from drizzle: sso-scim-schema.ts"""
    user_id = models.UUIDField()
    organization = models.ForeignKey('Organizations', on_delete=models.CASCADE, related_name='mfa_configurations_organization_set')
