 ...
 *
 * Must be rendered alongside every AI-generated output.
 * Provides clear disclosure that:
 * - Content is AI-generated
 * - Human review is required
 * - No actions are automatic
 *
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="space-y-1">
          ...
          <p className="text-amber-800">
            This content was generated by AI. It is advisory only and does not constitute a binding decision.
            A human must review and approve any action before it takes effect.
          </p>
          {auditRef && (
