-- Migration: Add Accounting Integration Tables (FIXED)
-- Created: 2026-02-13
...
DROP POLICY IF EXISTS external_invoices_org_isolation ON external_invoices;
...
DROP POLICY IF EXISTS external_payments_org_isolation ON external_payments;
...
DROP POLICY IF EXISTS external_customers_org_isolation ON external_customers;
...
DROP POLICY IF EXISTS external_accounts_org_isolation ON external_accounts;
