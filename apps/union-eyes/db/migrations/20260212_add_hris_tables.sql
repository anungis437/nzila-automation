-- Migration: HRIS Integration Tables
...
-- External HRIS provider enum (extends integration_provider for HRIS-specific use)
...
CREATE INDEX external_employees_org_id_idx ON external_employees (organization_id);
CREATE INDEX external_employees_provider_idx ON external_employees (external_provider);
CREATE INDEX external_employees_email_idx ON external_employees (email);
CREATE INDEX external_employees_status_idx ON external_employees (employment_status);
CREATE INDEX external_employees_synced_at_idx ON external_employees (last_synced_at);
...
-- Unique constraint
CREATE UNIQUE INDEX external_positions_org_provider_external_id_idx 
  ON external_positions (organization_id, external_provider, external_id);

-- Indexes
CREATE INDEX external_positions_org_id_idx ON external_positions (organization_id);
CREATE INDEX external_positions_provider_idx ON external_positions (external_provider);
CREATE INDEX external_positions_title_idx ON external_positions (title);
...
-- Unique constraint
CREATE UNIQUE INDEX external_departments_org_provider_external_id_idx 
  ON external_departments (organization_id, external_provider, external_id);

-- Indexes
CREATE INDEX external_departments_org_id_idx ON external_departments (organization_id);
CREATE INDEX external_departments_provider_idx ON external_departments (external_provider);
CREATE INDEX external_departments_name_idx ON external_departments (name);
CREATE INDEX external_departments_parent_idx ON external_departments (parent_department_id);
