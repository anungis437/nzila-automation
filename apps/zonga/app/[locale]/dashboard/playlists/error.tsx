...
export default function PlaylistsError({
  ...
  useEffect(() => {
    console.error('[Zonga Playlists Error]', error)
  }, [error])
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center rounded-xl border border-red-200 bg-red-50 p-8 text-center">
      ...
      <h2 className="text-navy text-xl font-bold">Playlist error</h2>
      <p className="mt-2 max-w-md text-sm text-gray-500">
        Something went wrong loading playlists. Please try again.
      </p>
      <button
        onClick={reset}
