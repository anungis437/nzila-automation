...
const statCards = [
  { label: "Active Cases", value: "47", change: "+5 this week", trend: "up" },
  { label: "Reports Generated", value: "128", change: "+12 this month", trend: "up" },
  { label: "Compliance Score", value: "96%", change: "+2% from last audit", trend: "up" },
  { label: "Team Members", value: "18", change: "3 pending invites", trend: "neutral" },
];
