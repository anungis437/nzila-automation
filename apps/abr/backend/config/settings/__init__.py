"""
Django settings for ABR Insights
This file is the package __init__ — it serves as config.settings
for production use. config.settings.test overrides for CI/testing.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("PGDATABASE", "nzila_abr_insights"),
