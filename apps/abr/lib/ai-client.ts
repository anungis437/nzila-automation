/**
 * AI client — ABR (Anti-Bribery & Reporting) app.
 *
 * Provides a singleton AI client for legal intelligence features:
 * legal research RAG, document extraction, compliance report drafting,
 * and citation-grounded legal research assistant.
 *
